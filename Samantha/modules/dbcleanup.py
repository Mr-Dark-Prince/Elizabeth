...
import Samantha.modules.sql.global_bans_sql as gban_sql
import Samantha.modules.sql.users_sql as user_sql
from Samantha import DEV_USERS, OWNER_ID, dispatcher
