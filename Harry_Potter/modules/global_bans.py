...
import Harry_Potter.modules.sql.global_bans_sql as sql
...
from Harry_Potter.modules.sql.users_sql import get_all_chats
...
def __user_info__(user_id):
    ...
    if is_gbanned:
        ...
        if user.reason:
            ...
            text += "\n\nAppeal to @D_A_R_K_P_R_I_N_C_E if you think it's invalid."
    else:
        text = text.format("No")
    return text
...
Harry Potter will constantly help banning spammers off from your group automatically So, you don't have to worry about spammers storming your group[.](https://telegra.ph/file/c1051d264a5b4146bd71e.jpg)
"""
