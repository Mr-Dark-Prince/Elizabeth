    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "Whoa! A Staff member just joined!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome yourself
                ...
                if creator:
                    ...
                    bot.send_message(
                        ...
                        parse_mode=ParseMode.HTML)
                update.effective_message.reply_text(
                    "You Have Invited Chizuru To Your Chat. *That's Awesome!*" 
                    "\nSend /help Command In PM To Know About Me More." 
                    "\nJoin Our Chats For [Discussion](https://t.me/ElitesOfAnime) & [Support](https://t.me/ElitesOfSupport). \n[Click Here](https://t.me/ElitesOfRobot) To Redirect In PM.", 
                     parse_mode=ParseMode.MARKDOWN, 
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            if left_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "Good Bye, Master!", reply_to_message_id=reply)
                return
